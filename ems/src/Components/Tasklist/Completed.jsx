...
const Completed = ({ data }) => {
    ...
    return (
        ...
        <div className=' flex-shrink-0 h-full rounded-xl w-[355px] bg-[#2c9ddf]'>
            ...
            <p className='text-s px-4 py-5  '> COMPLETED Create fuels sheets for all the remaining months of 2023. Make them according to the provided discription and create the sheets for all the stores </p>
